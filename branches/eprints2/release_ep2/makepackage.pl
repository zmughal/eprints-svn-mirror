...
my %codenames = (
	...
	"eprints2-3-10-99-1" => "Greek Salad",
	"eprints2-3-11" => "Wholegrain",
	"eprints2-3-11-99-1" => "Egor",
	"eprints2-3-11-99-2" => "Stag",
	"eprints2-3-11-99-3" => "Beetle",
	"eprints2-3-11-99-4" => "Teapot",
	"eprints2-3-11-99-5" => "Bottle",
	"eprints2-3-11-99-6" => "Cocktail",
	"eprints2-3-12" => "Southern Chicken",
);
...
my %ids = (
	...
	"eprints2-3-10-99-1" => "2.3.10.99.1-beta",
	"eprints2-3-11" => "2.3.11",
	"eprints2-3-11-99-1" => "2.3.11-99-1-beta",
	"eprints2-3-11-99-2" => "2.3.11-99-2-beta",
	"eprints2-3-11-99-3" => "2.3.11.99.3-beta",
	"eprints2-3-11-99-4" => "2.3.11.99.4-beta",
	"eprints2-3-11-99-5" => "2.3.11.99.5-beta",
	"eprints2-3-11-99-6" => "2.3.11.99.6-beta",
	"eprints2-3-12" => "2.3.12",
);
