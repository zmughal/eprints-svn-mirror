...
For example, if you are running \eprints\ on port 8080, you should change {\tt \$EPrintSite::SiteInfo::server\_static} to:
...
In the \eprints\ {\tt .forward} file:

\begin{verbatim}
"|IFS=' ' && exec /usr/bin/procmail -f- || exit 75"
\end{verbatim}

In the \eprints\ {\tt .procmailrc} file:
