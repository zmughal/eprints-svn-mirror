...
The C<rae_print_csv_footer> receives the number of rows printed as its argument, making it possible to add formulas to cells.
...
=head2 8. Allowing some users to enter data/make selections on behalf of others
