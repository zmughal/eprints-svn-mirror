...
The C</opt/eprints2/> directory (or whatever you called it). Not all the subdirectories I<have> to be backed up, but it is much easier to backup the whole thing.
...
Fortune favours the backed-up. It always seems to be the un-backed-up systems that disk crashes. Life's like that...
