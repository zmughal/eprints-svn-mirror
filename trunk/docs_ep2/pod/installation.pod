...
The configure script accepts a number of options, the most important are:

***** If you can read this, I forgot to add the option list. Doh. Try configure --help ****
...
For example:
    ...
    45 0 * * 0 /opt/eprints2/bin/send_subscriptions dookuprints monthly
